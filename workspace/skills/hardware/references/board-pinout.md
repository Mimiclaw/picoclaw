...
# Refer to: https://wiki.mimiclaw.io/hardware/en/maixcam/gpio.html
...
- https://wiki.mimiclaw.io/hardware/en/kvm/NanoKVM/introduction.html
...
- Download devmem from the Mimiclaw package repository
